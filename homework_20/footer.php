    ...
    <div class="container-fluid">
        <div class="footer-centre">
            <div class="menu-footer col-lg-4 row">
                <?php wp_nav_menu(array('classic' => 'footer_menu', 'menu_class' => 'nav-menu')); ?>
            </div>
            <div class="social-footer col-lg-4">
                <ul>
                    <?php if (have_posts()) : query_posts('p=47');
                        while (have_posts()) : the_post(); ?>
                            <li><a href="<?php echo get_post_meta($post->ID, 'soc_url', true); ?>" target="_blank"
            ...
            <div class="footer-right col-lg-4">
                <span>&copy; Copyright 2013
                    <?php if (have_posts()) : query_posts('p=58');
                        while (have_posts()) : the_post(); ?>
                            <a href="<?php echo get_post_meta($post->ID, 'designerfirs_url', true); ?>"
